module code.cloudfoundry.org/inigo

go 1.22.0

require (
	code.cloudfoundry.org/archiver v0.0.0-20240216143500-7a92f5fdc163
	code.cloudfoundry.org/auction v0.0.0-20231114155455-a0b5f6cb4f64
	code.cloudfoundry.org/auctioneer v0.0.0-20231114155042-4c948374cb66
	...
	code.cloudfoundry.org/fileserver v0.0.0-20230612151842-ddeb9bd6dfb9
	...
	code.cloudfoundry.org/localdriver v0.0.0-20230612151730-6d5a2bf56107
	...
	code.cloudfoundry.org/route-emitter v0.0.0-20240118163739-1b59f3b61461
	...
	code.cloudfoundry.org/vizzini v1.25.2-patch-8
